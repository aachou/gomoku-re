...
- `gomoku/` — internal package
  ...
  - `ui.py` — tkinter GUI; Ctrl+S/L save/load, Esc/菜单确认弹窗, 对局统计, AI等级提示, 高亮缓存, _restart_game, _layout_changed两遍法, 默认1200x800+min900x640; `GameUI = None` if tkinter missing
